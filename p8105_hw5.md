...
because the power of test increases with the increase in effect size. So
the average estimate of mu_hat that reject the null will become closer
to true mu as the effect size increases.
